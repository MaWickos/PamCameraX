package pollub.pam.pamcamerax;

import androidx.appcompat.app.AppCompatActivity;

import android.os.Bundle;

// Dodanie wymaganych importów
...
public class MainActivity extends AppCompatActivity {
    ...
    private final String PHOTO_FILE_NAME = "fotka.jpg";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Dodanie sprawdzania i żądania uprawnień gdy ich nie ma
        ...
        // Dodane wątku dla kamery
        cameraExecutor = Executors.newSingleThreadExecutor();

        // Dodanie katalogu do zapisu
...
//    }
    ...
    private boolean allPermissionsGranted() {
        ...
        // Pobranie uprawnień od użytkownika
    ...
    // Odczytywanie ścieżki katalogu dla zdjęć
